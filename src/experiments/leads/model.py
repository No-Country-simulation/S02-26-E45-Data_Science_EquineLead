...
def build_champion(datasets: dict) -> dict:
    ...
    print(
        f"scale_pos_weight — P1h:{spw_p1h:.2f}  P1p:{spw_p1p:.2f}  "
    ...
    return dict(
        ...
        p2h=p2h,
        p2p=p2p,
        params_p1h=PARAMS_P1H,
        params_p1p=PARAMS_P1P,
        params_p2h=PARAMS_P2H,
        params_p2p=PARAMS_P2P,
        spw_p1h=spw_p1h,
        spw_p1p=spw_p1p,
        spw_p2h=spw_p2h,
        spw_p2p=spw_p2p,
...
def save_models(outdir: str, p1h, p1p, p2h, p2p, label: str = "XGB_Tuneado"):
