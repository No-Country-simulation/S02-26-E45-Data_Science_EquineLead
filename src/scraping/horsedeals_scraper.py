    ...
    with sync_playwright() as p:
        ...
        for lurl in tqdm(
            ...
            try:
                ...
                # Location
                span_location = lsoup.select_one(
                    "div.header-module-location-KUa > a > span"
                )
                ...
                # Summary
                span_key_features = lsoup.select(
                    "div.summary-module-SummaryLeft-8TB > span"
                )
                span_value_features = lsoup.select(
                    "div.summary-module-SummaryRight-okZ > span"
                )
                ...
                a_breed = lsoup.select_one(
                    "div.summary-module-SummaryRight-okZ > a[href*='/breed/'] > span"
                )
                ...
                discipline = [
                    ...
                    for a_discipline in a_disciplines
                ]

                # Description
                div_description = lsoup.select_one("div.summary-module-viewAll--b2")
                description = (
                    div_description.get_text(strip=True) if div_description else None
                )
