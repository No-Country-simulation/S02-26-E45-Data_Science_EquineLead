...
FILTER_PATH = (
    "/browse-ssf--brf--clf--sxf--tgf--htf--agf--prf-15000%3A-"
...
def scrape_listings(max_pages=2):
    ...
    for page in tqdm(range(0, max_pages), total=max_pages, desc="Scraping Pages"):
        try:
            ...
            if not links:
                print(f"No more ads found on page {page}; stopping early.")
                break
