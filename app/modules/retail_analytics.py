    ...
    if not df_products.empty:
        ...
        with r1_c1:
            if 'Price' in df_products.columns:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_pp, "Retail Price Distribution"), use_container_width=True)
        with r1_c2:
            if 'Category' in df_products.columns:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_cat, "Top Volume Categories"), use_container_width=True)
        ...
        with r2_c1:
             if 'Stock' in df_products.columns:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_st, "Inventory Stock Levels"), use_container_width=True)
        with r2_c2:
            if 'Category' in df_products.columns and 'Price' in df_products.columns:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_cb, "Pricing Tiers by Category"), use_container_width=True)
        ...
        with r3_c1:
            if 'Price' in df_products.columns and 'Stock' in df_products.columns:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_ps, "Average Stock by Price Tier"), use_container_width=True)
        with r3_c2:
            if 'Category' in df_products.columns:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_tree, "Inventory Tree Map"), use_container_width=True)
