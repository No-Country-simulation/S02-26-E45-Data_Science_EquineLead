    ...
    if not df_users.empty:
        ...
        with r1_c1:
            if 'city' in filtered_users.columns and not filtered_users.empty:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_ci, "Hyperlocal: Top 15 Cities"), use_container_width=True)
        with r1_c2:
            if 'gender' in filtered_users.columns and not filtered_users.empty:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_ug, "User Identity Breakdown"), use_container_width=True)
        ...
        with r2_c1:
            if 'device_type' in filtered_users.columns and not filtered_users.empty:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_dev, "Hardware Telemetry"), use_container_width=True)
        with r2_c2:
            if 'first_seen' in filtered_users.columns and not filtered_users.empty:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_w, "Weekly Cohort Volume"), use_container_width=True)
        ...
        with r3_c1:
            if 'job_info' in filtered_users.columns and not filtered_users.empty:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_ji, "Professional Verticals"), use_container_width=True)
        with r3_c2:
             if 'country' in filtered_users.columns and 'traffic_source' in filtered_users.columns and not filtered_users.empty:
                 ...
                 if not sun.empty:
                     ...
                     st.plotly_chart(apply_pro_chart_style(fig_sun, "Traffic Flow by Top Regions"), use_container_width=True)
