    ...
    if not df_horses.empty:
        ...
        with r1_c1:
            if 'Price' in filtered_horses.columns and not filtered_horses.empty:
                ...
                if not df_hr.empty:
                    ...
                    st.plotly_chart(apply_pro_chart_style(fig_price, f"Pricing Distribution (Exclude Top 5%)"), use_container_width=True)
        with r1_c2:
            if 'Breed' in filtered_horses.columns and not filtered_horses.empty:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_b, "Top 15 Dominant Breeds"), use_container_width=True)
        ...
        with r2_c1:
            if 'Gender' in filtered_horses.columns and not filtered_horses.empty:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_g, "Gender Split"), use_container_width=True)
        with r2_c2:
            if 'Age' in filtered_horses.columns and 'Price' in filtered_horses.columns and not filtered_horses.empty:
                ...
                if not df_ha.empty:
                    ...
                    st.plotly_chart(apply_pro_chart_style(fig_sca, "Valuation vs Age Curve"), use_container_width=True)
        with r2_c3:
            if 'Color' in filtered_horses.columns and not filtered_horses.empty:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_col, "Top Coat Colors"), use_container_width=True)
        ...
        with r3_c1:
            if 'Breed' in filtered_horses.columns and 'Price' in filtered_horses.columns and not filtered_horses.empty:
                ...
                if not df_b_p.empty:
                    ...
                    st.plotly_chart(apply_pro_chart_style(fig_bp, "Valuation Variance by Top Breeds"), use_container_width=True)
        with r3_c2:
            if 'Location' in filtered_horses.columns and not filtered_horses.empty:
                ...
                st.plotly_chart(apply_pro_chart_style(fig_l, "Geographic Concentration"), use_container_width=True)
